...
public class Constants {
    ...
    public static final double SHOOTER_PERIOD = 0003;
    ...
    public static final int BOTTOM_THUMB_BUTTON = 2;
    public static final int LEFT_THUMB_BUTTON = 3;
    public static final int RIGHT_THUMB_BUTTON = 4;
}